...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('front_assets/images/logo/favourite_icon_1.png') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front_assets/css/stroke-gap-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('front_assets/css/icofont.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front_assets/css/nice-select.css') }}">

    <!-- woocommercen - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('front_assets/css/woocommerce-2.css') }}">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('front_assets/images/flug/flug_uk.png') }}" alt="image_not_found">
                                        </div>
                                        <select class="abe">
					...
					<div class="col col-lg-3 col-md-3 col-sm-12">
						<div class="brand_logo">
							<a class="brand_link" href="index.html">
								<img src="{{ asset('front_assets/images/logo/logo_1x.png') }}" srcset="{{ asset('front_assets/images/logo/logo_2x.png 2x') }}" alt="logo_not_found">
							</a>
						</div>
					</div>
					...
					<div class="col col-lg-6 col-md-6 col-sm-12">
						<form action="#">
							<div class="advance_serach">
                                <!----Search bar Category Components---->
								<x-category />
								<div class="form_item">
							...
							<div class="allcategories_collapse collapse" id="allcategories_collapse">
								<div class="card card-body">
									<ul class="allcategories_list ul_li_block">
										...
										<li><a href="shop_grid.html"><i class="fas fa-chevron-right"></i></i> {{ $category->category_name }}</a></li>
                                        @endforeach
									</ul>
								</div>
							</div>
            ...
            <ul class="cart_items_list ul_li_block mb_30 clearfix">
                ...
                <li>
                    <div class="item_image">
                        <img src="{{ asset('uplode/product/preview_image/'.$cart->cart_to_product->preview_image) }}" alt="image_not_found">
                    </div>
                    <div class="item_content">
                        <h4 class="item_title">{{ $cart->cart_to_product->product_name }}</h4>
                        <span class="item_price">TK {{ $cart->cart_to_product->after_discount }} X {{ $cart->quantity }}</span>
                    </div>
                    <a href="{{ route('cart.delete', $cart->id) }}" class="remove_btn"><i class="fal fa-trash-alt"></i></a>
                </li>
                @php
                  $total_price += $cart->cart_to_product->after_discount*$cart->quantity;
                @endphp
                @endforeach
            </ul>
...
================================================== -->
    ...
    <script src="{{ asset('front_assets/js/jquery-plugins-collection.js') }}"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="{{ asset('front_assets/js/gmaps.min.js') }}"></script>
