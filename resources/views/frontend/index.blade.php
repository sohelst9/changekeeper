            ...
            <div class="row">
                <div class="col-lg-9 offset-lg-3">
                    <div class="main_slider" data-slick='{"arrows": false}'>
                        <div class="slider_item set-bg-image" data-background="{{ asset('front_assets/images/slider/slide-2.jpg') }}">
                        ...
                        <div class="slider_item set-bg-image" data-background="{{ asset('front_assets/images/slider/slide-3.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                        ...
                        <div class="slider_item set-bg-image" data-background="{{ asset('front_assets/images/slider/slide-1.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                ...
                <div class="col-lg-9 order-lg-3">
                    <div class="best-selling-products">
                        <div class="sec-title-link">
                            <h3>All Products</h3>
                            <div class="view-all"><a href="{{ route('all_product') }}">View all<i class="fal fa-long-arrow-right"></i></a></div>
                        </div>
                        <div class="product-area clearfix row">

                            @foreach (collect($all_product)->take(6) as $product)
                             <div class="grid col-md-4">
                                    ...
                                    <div class="details">
                                        ...
                                        <h4><a href="{{ route('product_details',$product->id) }}">{{ $product->product_name }}</a></h4>
                                        <p><a href="{{ route('product_details',$product->id) }}">{{ $product->short_disc }}</a></p>
                                        <div class="rating">
                                        ...
                                        <div class="add-cart-area">
                                            ...
                                            @else
                                            <a class="product_sideber_btn btn btn-light add-to-cart text-dark" href="{{ route('register') }}">Add to cart</a>
                                            @endauth
                                        </div>
                                    </div>
                                    </form>
                                ...
                                <div class="category_boxed">
                                    <a href="#!">
                                            <span class="item_image">
                                                <img src="{{ asset('uplode/category/'.$category->category_image) }}" alt="image_not_found">
                                            </span>
                    ...
                    <div class="product-sidebar">
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="shop_details.html">
                                            <img src="{{ asset('uplode/product/preview_image/'.$product->preview_image) }}" alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
                        ...
                        <div class="widget product-add">
                            <div class="product-img">
                                <img src="{{ asset('front_assets/images/shop/product_img_10.png') }}" alt>
                            </div>
                            <div class="details">
                                <h4>iPad pro</h4>
        ...
        <div class="container">
            <div class="row promotion_banner_wrap">
                <div class="col col-lg-6">
                    <div class="promotion_banner">
                        <div class="item_image">
                            <img src="{{ asset('front_assets/images/promotion/banner_img_1.png')}}" alt>
                        </div>
                        <div class="item_content">
                ...
                <div class="col col-lg-6">
                    <div class="promotion_banner">
                        <div class="item_image">
                            <img src="{{ asset('front_assets/images/promotion/banner_img_2.png')}}" alt>
                        </div>
                        <div class="item_content">
            ...
            <div class="row newarrivals_products">
                ...
                <div class="col col-lg-7">
                    <div class="new-arrivals-grids clearfix row">
                        @foreach (collect($all_product)->take(4) as $product)
                            ...
                            <div class="details">
                                ...
                                <span class="price">
                                    ...
                                    <del aria-hidden="true">
                                        <span class="woocommerce-Price-amount amount">
                                            <bdi>
                                                <span class="woocommerce-Price-currencySymbol">TK </span>{{ $product->product_price }}
                                            </bdi>
                                        </span>
                                    </del>
