...
<div class="page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="#">View Category</a></li>
    </ol>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white">View Category Table</h3>
            </div>
            <div class="card-body">
                <table id="" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('category.edit',$category->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="{{ route('category.SoftDelete',$category->id) }}" class="btn btn-danger shadow btn-xs sharp">
