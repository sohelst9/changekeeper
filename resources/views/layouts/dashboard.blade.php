...
<head>
    ...
    <title>Changekeeper E-commerce Admin Dashboard</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="deznav">
				...
				<ul class="metismenu" id="menu">
                 ...
                 <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="{{ route('trashed_category') }}">View TrashedCategory</a></li>
                    </ul>
                  </li>
            ...
            <!---SubCategory sidebar----->
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="{{ route('View.SubCategory') }}">View Subcategory</a></li>
                    </ul>
                </li>
            ...
            <ul aria-expanded="false">
                <li><a href="{{ route('add.cupon') }}">Add Cupon</a></li>
            </ul>
        </li>
